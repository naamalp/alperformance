...
export default function ContactForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://alperformance.app.n8n.cloud/webhook/170df158-5345-49dd-a36e-56c2d1edea98', {
        method: 'POST',
        headers: {
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900">Contact the team</h2>
            ...
            <dl className="mt-10 space-y-4 text-base leading-7 text-gray-600">
              ...
              <div className="flex gap-x-4">
                ...
                <dd><a className="hover:text-gray-900" href="tel:02033416920">02033 416920</a></dd>
              </div>
              <div className="flex gap-x-4">
                <dt className="flex-none">
                ...
                <dd><a className="hover:text-gray-900" href="mailto:info@alperformance.co.uk">info@alperformance.co.uk</a></dd>
                ...
                <div 
                  className="relative left-[calc(5%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#1C3BD4] to-[#051D40] opacity-30 sm:left-[calc(5%+36rem)] sm:w-[72.1875rem]" 
